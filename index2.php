...
<?php
    ...
    } elseif (file_exists(__DIR__ . "/pages/{$pageName}/texts-ukr.inc")) { 
        $texts = include __DIR__ . "/pages/{$pageName}/texts-ukr.inc"; // Default to English if the file doesn't exist 
    } else {
        $texts = [];
    }
